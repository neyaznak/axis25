  ...
  return (
    <main className="min-h-screen bg-white px-4 py-12 text-gray-800">
      <div className="max-w-6xl mx-auto text-center">
        <h1 className="text-5xl font-bold text-blue-700 mb-4">Welcome to Axis25</h1>
        <p className="text-xl text-gray-600 mb-10">
          Designing Dreams into Reality – We build thoughtful, sustainable, and inspiring spaces.
        </p>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-100 p-6 rounded-xl shadow hover:shadow-lg transition">
            ...
            <p>Beautiful and functional homes tailored to your lifestyle and taste.</p>
          </div>
          ...
          <div className="bg-gray-100 p-6 rounded-xl shadow hover:shadow-lg transition">
            ...
            <p>Modern, efficient, and brand-focused workspaces that inspire teams.</p>
          </div>
          ...
          <div className="bg-gray-100 p-6 rounded-xl shadow hover:shadow-lg transition">
            ...
            <p>Green, relaxing outdoor designs that blend with architectural vision.</p>
          </div>
        </div>
      </div>
    </main>
